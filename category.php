...
<body>
    ...
    require_once 'admin/connect.php'; // kết nối đến cơ sở dữ liệu
    // $_GET['id'] lấy giá trị của tham số id từ URL.Tham số này sẽ được sử dụng để tìm các sản phẩm thuộc loại sản phẩm (classification)
    $id = $_GET['id'];
    # Truy vấn sản phẩm:
    ...
    <?php foreach ($result as $each): ?>
        <div class="product">
            ...
            <br>
            <br>
            <?php if(isset($_SESSION['user'])): ?> <!--Kiểm tra đăng nhập và cho phép thêm vào giỏ hàng -->
