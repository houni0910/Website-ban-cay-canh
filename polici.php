...
<head>
    ...
    <style>
       .header-nav {
        ...
        .container-poly {
            height: 180px;
            background-color: rgb(75, 193, 106);
            width: 100%;
        }
    ...
    <div id="poly">
        <div class="row">
            <div class="header-nav">
                ...
                <div class="nav-text">
                    <h2>
                        Trung tâm hỗ trợ Trees sẵn sàng phục vụ quý khách
                    </h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="container-poly">
                <div class="container-tex">
                    <h1>Xin chào, Trees  có thể giúp gì cho bạn ?</h1>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="content-poly">
                ...
                <div class="content-poly_right">
                    ...
                    <h4>
                        Giới thiệu
                        <p>
                            Trang web Trees thuộc sở hữu của HUMG, là bên kiểm soát dữ liệu đối với dữ liệu cá nhân của bạn.
                            ...
                            Do đó, bạn phải đọc Chính Sách Bảo Mật này trước khi sử dụng trang web Trees .
                    ...
                    <h4>
                        ...
                        <p>
                            Khi bạn truy cập Trees.com, chúng tôi tự động thu thập một số thông tin nhất định về thiết bị của bạn,
                    ...
                    <h4>
                        ...
                        <p>
                            ...
                            Ví dụ: bạn sẽ không thể nhận bản tin của chúng tôi hoặc liên hệ trực tiếp với chúng tôi từ trang web. Người dùng không chắc chắn về những thông tin bắt buộc có thể liên hệ với chúng tôi qua Trees@gmail.com.
                        </p>            
                    </h4>
                    <h4>
                        Bảo mật thông tin:
                    ...
                    <h4>
                        ...
                        <p>
                            ...
                            bạn có thể gửi email tới Trees@gmail.com.
                        </p>
                    </h4>
                    ...
                    <h4>
                        Cookie:
                        <p>
                            Trang web sử dụng cookie để giúp cá nhân hóa trải nghiệm trực tuyến của bạn. Bằng cách truy cập vào Trees , bạn đã đồng ý sử dụng các cookie được yêu cầu.
                    ...
                    <h4>
                        Giấy phép:
                        <p>
                            Trừ khi có quy định khác, Trees  và/hoặc người cấp phép của nó sở hữu quyền sở hữu trí tuệ đối với tất cả tài liệu trên Trees . Tất cả các quyền sở hữu trí tuệ được bảo lưu. Bạn có thể truy cập vào phần này từ Trees cho mục đích sử dụng cá nhân của riêng bạn theo các hạn chế được đặt ra trong các điều khoản và điều kiện này.
                            Bạn không được:
                            <br>
                            *Bán, cho thuê hoặc cấp phép lại tài liệu từ Trees 
                            <br>
                            *Sao chép hoặc xuất bản lại tài liệu từ Trees 
                            <br>
                            *Phân phối lại nội dung từ Trees 
                            <br>
                            *Sao chép, nhân bản hoặc sao chép tài liệu từ Trees 
                            <br>
                            ...
                            *Các phần của trang web này cung cấp cho người dùng cơ hội để đăng và trao đổi ý kiến ​​và thông tin trong các lĩnh vực nhất định của trang web.
                            <br>
                            *Trees  không lọc, chỉnh sửa, xuất bản hoặc xem xét các bình luận trước khi chúng hiện diện trên trang web. Các bình luận không phản ánh quan điểm và ý kiến ​​của Trees ,
                            các đại lý và/hoặc affiliate của Trees . Bình luận phản ánh quan điểm và ý kiến ​​của người đăng bình luận và ý kiến ​​của họ. Trong phạm vi luật hiện hành cho phép, Trees  sẽ không chịu trách nhiệm về bình luận hoặc bất kỳ trách nhiệm pháp lý, thiệt hại hoặc chi phí nào gây ra và/hoặc phải gánh chịu do bất kỳ việc sử dụng và/hoặc đăng và/hoặc sự xuất hiện của bình luận trên trang web này
                            <br>    
                            *Trees có quyền giám sát tất cả các bình luận và xóa bất kỳ bình luận nào có thể được coi là không phù hợp, xúc phạm hoặc vi phạm các Điều khoản và Điều kiện này.
                            ...
                            <br>
                            -Theo đây, bạn cấp cho Trees giấy phép không độc quyền để sử dụng, tái tạo, chỉnh sửa và cho phép người khác sử dụng, tái tạo và chỉnh sửa bất kỳ bình luận nào của bạn ở bất kỳ và tất cả các hình thức, định dạng, hoặc phương tiện truyền thông.
                        </p>
                    </h4>
                    <h4>
                        <p></p>
            ...
            <div class="boxcenter">
               <div class="box1">
                 <h4 style="text-align: center;">
                    ©2024 Trees . Tất cả các quyền được bảo lưu.
                 </h4>
               </div>
               <div class="box2">
